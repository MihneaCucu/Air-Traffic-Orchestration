...
\textbf{Comparativ cu DDPG/TD3:}
\begin{itemize}
    \item \textbf{Auto-tuning}: Nu necesită tuning manual al noise-ului de explorare
    \item \textbf{Maximum entropy}: Framework teoretic mai solid
    \item \textbf{Mai robust}: Evită mode collapse prin entropic regularization
\end{itemize}
